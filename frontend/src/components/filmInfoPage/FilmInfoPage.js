...
export const FilmInfoPage = () => {
    return (
        <div className='mainSlider'>
            <img src="https://cdn.steemitimages.com/DQmTwwmyu86zijepR9knXkSx43mozvKdnvkjjcUYjD7Vpqe/%E5%9B%BE%E7%89%87.png" className='mainPhoto' alt="AVA"/>
            ...
            <div className="rate">
                ...
                <span className='digits'>6.4</span>
                ...
                <span className='digits'>8.4</span>
                ...
                <span className='digits'>7.4</span>
                <span className='digits'>2005</span>
                <span className='digits'>18+</span>
                <span className='digits'>Фантастика</span>
            </div>
            <div className="title">
                <h1 className='tit'>Звездные войны: Эпизод 3 — Месть ситхов</h1>
            </div>
        </div>
    );
};